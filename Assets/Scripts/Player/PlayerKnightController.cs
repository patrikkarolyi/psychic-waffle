...
public class PlayerKnightController : MonoBehaviour
{
    ...
    private bool activeShieldOn = false;
    public Transform activeShield;
    public Transform passiveShield;
    ...
    {
        if (activeShieldOn != animatorAming)
        {
            activeShield.gameObject.SetActive(activeShieldOn);
            passiveShield.gameObject.SetActive(animatorAming);
            activeShieldOn = animatorAming;
        }
    }
